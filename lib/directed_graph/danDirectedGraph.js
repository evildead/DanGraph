...
exports.DanDirectedGraph = exports.ArcType = void 0;
const lodash_1 = __importDefault(require("lodash"));
const commons_1 = require("../commons");
const commonUtils_1 = require("../utils/commonUtils");
const danDirectedGraphDepthFirstIterator_1 = require("./danDirectedGraphDepthFirstIterator");
const danDirectedGraphBreadthFirstIterator_1 = require("./danDirectedGraphBreadthFirstIterator");
var ArcType;
(function (ArcType) {
...
class DanDirectedGraph {
    ...
    getNodeAndDirectedArcsFromNodeId(idNode) {
    ...
    getDepthFirstIterator(startingNodeId) {
        return new danDirectedGraphDepthFirstIterator_1.DanDirectedGraphDepthFirstIterator(this, startingNodeId);
    }
    getBreadthFirstIterator(startingNodeId) {
        return new danDirectedGraphBreadthFirstIterator_1.DanDirectedGraphBreadthFirstIterator(this, startingNodeId);
    }
}
